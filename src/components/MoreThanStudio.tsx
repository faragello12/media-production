...
export function MoreThanStudio() {
  return (
          ...
          <div className="relative p-7 sm:p-10 lg:p-12">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-base leading-7 text-mp-muted">
                We blend creative direction, production, and post to make your message
                feel premium on every platform.
              </p>
              <div className="mt-6 flex flex-wrap gap-3" data-animate-group>
                {["Shoot planning", "Directing", "Editing", "Color grade"].map((t) => (
                  <span
                    key={t}
